...
export const SCHEMA_DIGEST = "0b846a8faf997849" as const;
...
export interface GrantScopeResult {
  ...
  breadth?: {
    /** Element-anchored permissions. Zero until scope anchors (A15) ship; until then breadth is an application-spread proxy. */
    anchors: number;
